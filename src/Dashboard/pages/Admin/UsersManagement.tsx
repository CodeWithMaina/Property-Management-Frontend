// src/Dashboard/pages/Admin/UsersManagement.tsx
 ...
 * 
 * Main container component for users management with tab navigation.
 * Handles redirects to default child route and provides navigation
 * between different users-related views.
 * 
 * @component
 * @example
...
export const UsersManagement: React.FC = () => {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {/* Tab navigation for switching between users views */}
      <nav className="flex border-b border-gray-200 dark:border-gray-700" aria-label="Users management tabs">
        <NavLink
          to="analytics"
          className={({ isActive }) =>
